create or replace procedure addRentEScooter(id_rent_parameter in VARCHAR, id_vehicle_parameter in VARCHAR, user_name_parameter in VARCHAR) is
...
begin
    ...
    values (id_rent_parameter, mail ,id_vehicle_parameter, id_park_variable, null, systimestamp, null, 0, 0,0);
    ...
    update park set available_escooters = available_escooters-1 where id_park_variable = park.id_park;
EXCEPTION
