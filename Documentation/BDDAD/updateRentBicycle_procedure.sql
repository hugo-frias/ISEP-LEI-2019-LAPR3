create or replace procedure updateRentBicycle(id_vehicle_parameter in varchar, user_name_parameter in VARCHAR, 
    ...
    update park set available_bicycles = available_bicycles+1 where id_park_end_parameter = park.id_park;
