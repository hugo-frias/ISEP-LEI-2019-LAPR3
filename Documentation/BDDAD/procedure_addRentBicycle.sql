create or replace procedure addRentBicycle(id_rent_parameter in VARCHAR, id_vehicle_parameter in VARCHAR, user_name_parameter in VARCHAR) is
...
begin
    ...
    update park set available_bicycles = available_bicycles-1 where id_park_variable = park.id_park;
EXCEPTION
