 ...
 * @author Hugo
 */
public class shortestPathComparatorTest {
    
    public shortestPathComparatorTest() {
    }
    ...
    /**
     * Test of compare method, of class shortestPathComparator.
     */
    @Test
    public void testCompare() {
        ...
        o2.add(place);
        o2.add(vDest);
        shortestPathComparator instance = new shortestPathComparator();
        int expResult = -1;
