...
class EdgeTest {
    ...
    public void testGetEndpoints() {
        ...
        instance.setVDest(null);
        String[] expResult3 = {"Vertex2", null};
    ...
    public void testEquals() {
        ...
        Edge<String, String> otherEdge1 = new Edge<>("edge1", 1.0, null, vertex1);

        assertFalse(instance.equals(otherEdge1));
        ...
        instance.setVOrig(null);
        instance.setVDest(null);
        instance.setElement("df");
        instance.setWeight(1.0);

        Edge<String, String> otherEdge2 = new Edge<>("edge1", 1.0, null, null);
        assertFalse(instance.equals(otherEdge2));
        ...
        assertTrue(instance.equals(otherEdge));
    }
