 ...
 * @author Hugo
 */
public class numberOfPlacesComparatorTest {
    
    public numberOfPlacesComparatorTest() {
    }
    ...
    /**
     * Test of compare method, of class numberOfPlacesComparator.
     */
    @Test
    public void testCompare() {
        ...
        numberOfPlacesComparator instance = new numberOfPlacesComparator();
        int expResult = -1;
