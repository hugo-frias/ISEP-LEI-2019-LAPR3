...
class VertexTest {
    ...
    public void testEquals() {
        ...
        Vertex<String, Integer> instance4 = new Vertex<>(1, "Vertex2");
        assertTrue(instance2.equals(instance4) == false);

        Vertex<String, Integer> instance5 = new Vertex<>(2, "Vertex5");
        assertTrue(instance2.equals(instance5) == false);

        Vertex<String, Integer> instance6 = new Vertex<>(2, "Vertex2");
        assertTrue(instance2.equals(instance6) == true);

        Edge<String, Integer> edge3 = new Edge<>(null, 3, instance2, instance6);
        Edge<String, Integer> edge4 = new Edge<>(null, 3, instance3, instance6);
        instance2.addAdjVert("fg", edge3);
        instance6.addAdjVert("fg", edge4);
        Vertex<String, Integer> instance7 = new Vertex<>(instance6);
        assertTrue(instance2.equals(instance7) == false);
    }
    ...
    public void testToString() {
        ...
        Vertex<String, Integer> instance1 = new Vertex<>(2, "Vertex2");
        Vertex<String, Integer> instance2 = new Vertex<>(instance1);
