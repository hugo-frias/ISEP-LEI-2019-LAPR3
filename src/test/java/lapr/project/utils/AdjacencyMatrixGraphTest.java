...
public class AdjacencyMatrixGraphTest {
    ...
    public void testOutDegree() {
        ...
        instance.insertVertex("v");

        assertTrue("out degree should be 0", instance.outDegree("v") == 0);
        ...
        assertTrue("out degree should be -1", instance.outDegree("xslxs") == -1);
    ...
    public void testGetEdge() {
        ...
        assertTrue("edge should be Edge 4", instance.privateGet(1, 2).equalsIgnoreCase("Edge 4"));

        instance.privateSet(1, 2, "Edge 6");
        instance.privateSet(1, 2, "Edge 4");
        ...
        assertTrue("edge should be -1", instance.getEdge("xslxs", "Vert 2") == null);

        assertTrue("edge should be -1", instance.getEdge("Vert 2", "xslxs") == null);
    }
    ...
    public void testInsertEdge() {
        ...
        assertTrue("result should be true", instance.insertEdge("Vert 2", "Vert 4", "Edge 3"));
        assertTrue("result should be two", (instance.numEdges() == 2));
        ...
        assertFalse("result should be false", instance.insertEdge("Vert 1", "Vert 1", "Edge 4"));

        assertFalse("result should be false", instance.insertEdge("shs", "Vert 1", "Edge 4"));
        assertFalse("result should be false", instance.insertEdge("Vert 1", "shs", "Edge 4"));

        assertFalse("result should be false", instance.insertEdge("Vert 2", "Vert 4", "Edge 3"));
    ...
    public void testInsertVertex() {
        ...
        assertTrue("result should be true", instance.insertVertex("Vert 4"));

        assertTrue("result should be true", instance.checkVertex("Vert 2"));

        assertFalse("result should be false", instance.checkVertex("Vertex1"));
    ...
    public void testRemoveVertex() {
        ...
        assertTrue("result should be true", instance.removeVertex("V"));
        ...
        assertFalse("result should be false", instance.removeVertex("sdkds"));
    ...
    public void testRemoveEdge() {
        ...
        assertTrue("result should be Edge 3", instance.removeEdge("Vert 4", "Vert 2").equalsIgnoreCase("Edge 3"));

        assertTrue("result should be null", instance.removeEdge("snsn", "Vert 2") == null);

        assertTrue("result should be null", instance.removeEdge("Vert 4", "sbsns") == null);
    ...
    public void testEqualsObject() {
        ...
        Object c = new Object();
        assertFalse("result should be false", instance.equals(c));

        instance3.removeEdge("Vert 1", "Vert 5");
        instance3.insertEdge("Vert 4", "Vert 5", "Edge 5");
        assertFalse("result should be false", instance.equals(instance3));

        instance3.removeEdge("Vert 1", "Vert 5");
        instance3.insertEdge("Vert 1", "Vert 5", "Edge 6");
        assertFalse("result should be false", instance.equals(instance3));
    }
